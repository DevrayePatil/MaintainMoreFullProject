...
public class ServiceBookingAdapter extends RecyclerView.Adapter<ServiceBookingAdapter.viewHolder>{
    ...
    public ServiceBookingAdapter(ArrayList<ServiceBookingModels> bookingModels, Context context,
                                 viewHolder.OnServiceBookingCardClickListener bookingCardClickListener) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.card_booking_for_user, parent, false);
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        holder.displayStatus.setText(models.getDisplayStatus());
